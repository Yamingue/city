 ...
 */
final class Version20210111011425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__city AS SELECT id, name FROM city');
        ...
        $this->addSql('INSERT INTO city (id, name) SELECT id, name FROM __temp__city');
