 ...
 */
final class Version20210112141506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chambre AS SELECT id, type_id, city_id, nom, cuisine, description, poster FROM chambre');
        $this->addSql('DROP TABLE chambre');
        $this->addSql('CREATE TABLE chambre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, city_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, cuisine BOOLEAN NOT NULL, description CLOB NOT NULL COLLATE BINARY, poster VARCHAR(255) NOT NULL COLLATE BINARY, douche BOOLEAN NOT NULL, CONSTRAINT FK_C509E4FFC54C8C93 FOREIGN KEY (type_id) REFERENCES type_chabre (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C509E4FF8BAC62AF FOREIGN KEY (city_id) REFERENCES city (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO chambre (id, type_id, city_id, nom, cuisine, description, poster) SELECT id, type_id, city_id, nom, cuisine, description, poster FROM __temp__chambre');
        ...
        $this->addSql('CREATE TABLE city (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, poster VARCHAR(255) NOT NULL COLLATE BINARY, commentaire CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_2D5B0234A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chambre AS SELECT id, type_id, city_id, nom, cuisine, description, poster FROM chambre');
        $this->addSql('DROP TABLE chambre');
        $this->addSql('CREATE TABLE chambre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, city_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, cuisine BOOLEAN NOT NULL, description CLOB NOT NULL, poster VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO chambre (id, type_id, city_id, nom, cuisine, description, poster) SELECT id, type_id, city_id, nom, cuisine, description, poster FROM __temp__chambre');
        $this->addSql('DROP TABLE __temp__chambre');
        $this->addSql('CREATE INDEX IDX_C509E4FFC54C8C93 ON chambre (type_id)');
        $this->addSql('CREATE INDEX IDX_C509E4FF8BAC62AF ON chambre (city_id)');
