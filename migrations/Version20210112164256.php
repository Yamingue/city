 ...
 */
final class Version20210112164256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chambre AS SELECT id, type_id, city_id, nom, cuisine, description, poster, douche FROM chambre');
        ...
        $this->addSql('INSERT INTO chambre (id, type_id, city_id, nom, cuisine, description, poster, douche) SELECT id, type_id, city_id, nom, cuisine, description, poster, douche FROM __temp__chambre');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chambre AS SELECT id, type_id, city_id, nom, cuisine, description, poster, douche FROM chambre');
        $this->addSql('DROP TABLE chambre');
        $this->addSql('CREATE TABLE chambre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, city_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, cuisine BOOLEAN NOT NULL, description CLOB NOT NULL, poster VARCHAR(255) NOT NULL, douche BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO chambre (id, type_id, city_id, nom, cuisine, description, poster, douche) SELECT id, type_id, city_id, nom, cuisine, description, poster, douche FROM __temp__chambre');
        $this->addSql('DROP TABLE __temp__chambre');
        $this->addSql('CREATE INDEX IDX_C509E4FFC54C8C93 ON chambre (type_id)');
        $this->addSql('CREATE INDEX IDX_C509E4FF8BAC62AF ON chambre (city_id)');
