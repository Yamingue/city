 ...
 */
final class Version20210112133404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chambre AS SELECT id, type_id, nom, cuisine, description FROM chambre');
        $this->addSql('DROP TABLE chambre');
        $this->addSql('CREATE TABLE chambre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, cuisine BOOLEAN NOT NULL, description CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_C509E4FFC54C8C93 FOREIGN KEY (type_id) REFERENCES type_chabre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO chambre (id, type_id, nom, cuisine, description) SELECT id, type_id, nom, cuisine, description FROM __temp__chambre');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chambre AS SELECT id, type_id, nom, cuisine, description FROM chambre');
        $this->addSql('DROP TABLE chambre');
        $this->addSql('CREATE TABLE chambre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, cuisine BOOLEAN NOT NULL, description CLOB NOT NULL, boolean BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO chambre (id, type_id, nom, cuisine, description) SELECT id, type_id, nom, cuisine, description FROM __temp__chambre');
        $this->addSql('DROP TABLE __temp__chambre');
        $this->addSql('CREATE INDEX IDX_C509E4FFC54C8C93 ON chambre (type_id)');
        $this->addSql('DROP INDEX IDX_2D5B0234A76ED395');
